...
void School_afternoon_view() {glClearColor(0.98f, 0.773f, 0.357, 0.714f);// Set background color to Sky blue
...
/// Man BoY 1
 glPushMatrix();
	 glTranslatef(+0.37f, +0.11f, 0.0f);
      glPushMatrix();

	 glTranslatef(+0.08f, -0.1f, 0.0f);///translation for boy
...

{
 ...
 /*{
    ...
    glLoadIdentity();
    gluOrtho2D(0, 70, 0, 80); // Set the 2D coordinate system
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();

    const char* text = "Ptoltuli High School"; // Text to display
